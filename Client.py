...
class Client:
	...
	def listenRtp(self):		
		...
		while True:
			try:
				...
				# timeout is normal, just check flags and loop
	...
	def sendRtspRequest(self, requestCode):
		...
		try:
			...
			tkMessageBox.showwarning('Connection Error', 'Failed to send RTSP request to server.')
			return
	...
	def parseRtspReply(self, data):
		...
		lines = data.split('\n')
		# Defensive: ensure at least 3 lines to parse
		if len(lines) < 3:
			return
		try:
	...
	def openRtpPort(self):
		...
		try:
			...
			print("Bind RTP port", self.rtpPort)
		except:
